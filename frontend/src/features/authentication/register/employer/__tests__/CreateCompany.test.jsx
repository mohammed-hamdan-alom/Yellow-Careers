...
describe('CreateCompany Component', () => {
  ...
  it('submits company information', async () => {
    ...
    fireEvent.change(companyNameInputField, { target: { value: 'Company Name' } })
    ...
    await waitFor(() =>
      expect(AxiosInstance.post).toHaveBeenCalledWith('api/companies/create/', { company_name: 'Company Name', website: 'Website', about: 'About'})
    )
  })
});