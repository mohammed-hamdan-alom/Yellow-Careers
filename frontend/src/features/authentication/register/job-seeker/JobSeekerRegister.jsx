          ...
          <CardContent>
            <form onSubmit={handleSubmit}>
              <div className="space-y-2 mb-4">
                ...
                />
                {errors.email && (
                  <BigAlert message={errors.email} type="error" />
                )}
              </div>
              <div className="flex space-x-4 mb-4">
                <div className="w-1/2 space-y-2">
                  ...
                  />
                  {errors.password && (
                    <BigAlert message={errors.password} type="error" />
                  )}
                </div>
                <div className="w-1/2 space-y-2">
                  ...
                  />
                  {errors.password2 && (
                    <BigAlert message={errors.password2} type="error" />
                  )}
                </div>
              </div>
              <div className="flex space-x-4 mb-4">
                <div className="w-1/2 space-y-2">
                  ...
                  />
                  {errors.first_name && (
                    <BigAlert message={errors.first_name} type="error" />
                  )}
                </div>
                <div className="w-1/2 space-y-2">
                  ...
                  />
                  {errors.last_name && (
                    <BigAlert message={errors.last_name} type="error" />
                  )}
                </div>
              </div>
              <div className="space-y-2 mb-4">
                ...
                />
                {errors.other_names && (
                  <BigAlert message={errors.other_names} type="error" />
                )}
              </div>
              ...
              <div className="space-y-2 mb-4">
                ...
                />
                {errors.phone_number && (
                  <BigAlert message={errors.phone_number} type="error" />
                )}
              </div>
              <div className="space-y-2 mb-4">
                ...
                />
                {errors.nationality && (
                  <BigAlert message={errors.nationality} type="error" />
                )}
              </div>
              <div className="space-y-2">
                ...
                {errors.sex && (
                  <BigAlert message="Please pick a choice" type="error" />
                )}
              </div>
              <div className="mt-4">
                <Button
