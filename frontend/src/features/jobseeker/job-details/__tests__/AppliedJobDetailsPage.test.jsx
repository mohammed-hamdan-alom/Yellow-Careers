...
describe("AppliedJobDetailsPage component without questions", () => {
    beforeEach(async () => {
        vi.clearAllMocks()
        vi.spyOn(AxiosInstance, "get").mockImplementation(() => { return Promise.resolve({ data: data.application }) })
        vi.spyOn(AxiosInstance, "get").mockImplementationOnce(() => { return Promise.resolve({ data: data.resume }) })
        vi.spyOn(AxiosInstance, "get").mockImplementationOnce(() => { return Promise.resolve({ data: [] }) })
        vi.spyOn(AxiosInstance, "get").mockImplementationOnce(() => { return Promise.resolve({ data: [] }) })
        await act(async () => {
            render(
                <MemoryRouter>
