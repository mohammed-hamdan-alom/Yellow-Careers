...
const jobsData = [
  ...
  },
  {
    ...
    description:
      "Pariatur magnam quisquam distinctio. Repudiandae asperiores quidem dolor. Voluptatum omnis dolorem magnam et commodi magnam officiis.",
  ...
  },
  {
    ...
    description:
      "Aliquid mollitia vitae blanditiis dignissimos dignissimos. Maiores architecto voluptatum ex. Corrupti voluptatem esse eum nostrum adipisci explicabo.",
    address: { country: "Germany" },
    job_type: "PT",
    salary: 61939,
  },
...
describe("JobSeekerDashboardPage component with no resume", () => {
  beforeEach(async () => {
    await act(async () => {
      render(
        <MemoryRouter>
...
describe("JobSeekerDashboardPage component with resume", () => {
  beforeEach(async () => {
    await act(async () => {
      render(
        <MemoryRouter>
  ...
  test("renders job list when resume found", async () => {
    ...
    const noResumeText = await screen.queryByText(
