    ...
    <div className="mt-4 w-full flex flex-col justify-left mr-10">
      ...
      <form onSubmit={handleSubmitResume}>
        <div className="flex space-x-4">
          <div className="w-1/2">
            <Label className="text-1xl" htmlFor="github">
              Github:
            </Label>
            <Input
              type="text"
          ...
          <div className="w-1/2">
            <Label className="text-1xl" htmlFor="linkedin">
              LinkedIn:
            </Label>
            <Input
              type="text"
        ...
        <div className="mt-4">
          <Label className="text-1xl" htmlFor="about">
            About:
          </Label>
          <Textarea name="about" id="about" value={resume.about} onChange={handleResumeChange} />
        </div>
        <div className="mt-4">
          <Label className="text-1xl" htmlFor="experience">
            Experience:
          </Label>
          <Textarea
            name="experience"
        ...
        <Button type="submit" className="mt-4" data-testid="submit-button">
          Update Resume
        </Button>
      </form>
    </div>
