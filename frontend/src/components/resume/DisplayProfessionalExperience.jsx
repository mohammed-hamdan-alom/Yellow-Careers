  ...
  return (
    <div className="bg-white shadow-purple rounded-md p-6 mt-6">
      <h3 className="text-lg font-semibold mb-2">
        <Tag className="tag-large" color="purple">Professional Experience</Tag>
      </h3>
      {professionalExperiences.map((professionalExperience, index) => (
        <div key={index} className="mb-6">
          ...
          <p className="mb-2"><span className="font-semibold">Start Date:</span> {professionalExperience.start_date}</p>
          <p className="mb-2"><span className="font-semibold">End Date:</span> {professionalExperience.end_date}</p>
          <p className="mb-2"><span className="font-semibold">Company:</span> {professionalExperience.company}</p>
          <p className="mb-2"><span className="font-semibold">Position:</span> {professionalExperience.position}</p>
          {professionalExperience.address && (
            <div className="flex items-center">
              <MapPin className="mr-2 text-gray-700" size={20} />
              <Label><strong>Location:</strong> {professionalExperience.address.post_code}, {professionalExperience.address.city}, {professionalExperience.address.country}</Label>
            </div>
          )}
