  ...
  return (
    <>
      <div className="min-h-full">
        <Disclosure as="nav" className="sticky border-b-[1px] top-0 z-40 w-full bg-white dark:border-b-slate-700 dark:bg-background">
          {({ open }) => (
            <>
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      Yellow Careers {/* ADD A LOGO HERE */}
                    </div>
                ...
                <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                  {navigation.map((item) => (
                    ...
                    href={item.href}
                    className={classNames(
                      item.current ? 'bg-white text-black' : 'text-gray-300 hover:text-black',
