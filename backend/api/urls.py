...
urlpatterns = [
    ...
    path('jobs/', JobListingView.as_view(), name='all_jobs'),
    path('jobs/create-job', JobCreationView.as_view(), name='create_job'),
    path('jobs/<int:pk>/', JobRetrieveView.as_view(), name='get_job'),
    path('jobs/<int:pk>/questions/', JobQuestionListView.as_view(), name='job_question_list'),
    path('jobs/<int:pk>/address/', AddressRetrieveJobView.as_view(), name='job_address'),
    path('jobs/<int:pk>/company/', JobCompanyRetrieveView.as_view(), name='job_company'),
    path('jobs/<int:pk>/update-archive/', JobUpdateArchiveView.as_view(), name='update_job_archive'),

    path('addresses/', AddressListView.as_view(), name='address_list'),
    path('addresses/<int:pk>/', AddressRetrieveView.as_view(), name='address_get'),
    path('addresses/create/', AddressCreateView.as_view(), name='address_post'),
    path('addresses/<int:pk>/update/', AddressUpdateView.as_view(), name='address_put'),

    path('answers/', AnswerListView.as_view(), name='answer_list'),
    path('answers/create/', AnswerCreateView.as_view(), name='answer_post'),
    path('answers/<int:pk>/update/', AnswerUpdateView.as_view(), name='answer_put'),

    path('applications/', ApplicationListView.as_view(), name='application_list'),
    path('applications/<int:pk>/', ApplicationRetrieveView.as_view(), name='application_get'),
    path('applications/create/', ApplicationCreateView.as_view(), name='application_post'),
    path('applications/<int:pk>/update/', ApplicationUpdateView.as_view(), name='application_put'),
    path('applications/<int:job_seeker_id>/<int:job_id>/', JobSeekerApplicationRetrieveView.as_view(), name='job_seeker_application_get'),
    path('applications/<int:application_id>/resume/', ApplicationResumeRetrieveView.as_view(), name='application_resume_get'),
    path('applications/<int:application_id>/answers/', ApplicationAnswerListView.as_view(), name='application_answer_list'),
