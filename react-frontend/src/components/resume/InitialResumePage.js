...
function UpdateResumePage2() {
  ...
  useEffect(() => {
    async function fetchResumeId() {
      const response = await AxiosInstance.get(
        `http://localhost:8000/api/job-seekers/${userId}/`
      );
  ...
  useEffect(() => {
    ...
    AxiosInstance.get(
      `http://localhost:8000/api/resumes/${resumeId}/soft-skills/`
    )
      .then((response) => {
        setSoftSkills(response.data.map((item) => item.skill));
      })
      .then((response) => console.log(response))
      .catch((error) => console.error("Error:", error));
    ...
    AxiosInstance.get(
      `http://localhost:8000/api/resumes/${resumeId}/technical-skills/`
    )
      .then((response) => {
        setTechnicalSkills(response.data.map((item) => item.skill));
      })
      .then((response) => console.log(response))
      .catch((error) => console.error("Error:", error));
    ...
    AxiosInstance.get(
      `http://localhost:8000/api/resumes/${resumeId}/languages/`
    )
      .then((response) => {
    ...
    AxiosInstance.get(
      `http://localhost:8000/api/resumes/${resumeId}/educations/`
    )
      .then((response) => {
    ...
    AxiosInstance.get(
      `http://localhost:8000/api/resumes/${resumeId}/professional-experiences/`
    )
      .then((response) => {
  ...
  const handleSubmitSoftSkills = (event) => {
    event.preventDefault();
    AxiosInstance.post(
      `http://localhost:8000/api/resumes/${resumeId}/soft-skills/create/`,
      {
        skill: softSkill,
      }
    )
  ...
  const handleSubmitLanguages = (event) => {
    event.preventDefault();
    AxiosInstance.post(
      `http://localhost:8000/api/resumes/${resumeId}/languages/create/`,
      {
  ...
  const handleSubmitProfessionalExperiences = (event) => {
    event.preventDefault();
    AxiosInstance.post(
      `http://localhost:8000/api/resumes/${resumeId}/professional-experiences/create/`,
      {
  ...
  const handleSubmitEducations = (event) => {
    event.preventDefault();
    AxiosInstance.post(
      `http://localhost:8000/api/resumes/${resumeId}/educations/create/`,
      {
      ...
      <form onSubmit={handleSubmitEducations}>
        ...
        <label>
          ...
          <input
            type="text"
            name="city"
            defaultValue={education.address.city}
            onChange={handleEducationChange}
          />
          {errors.education && <p>{errors.education}</p>}
        </label>
        ...
        <label>
          ...
          <input
            type="text"
            name="post-code"
            defaultValue={education.address.post_code}
            onChange={handleEducationChange}
          />
          {errors.education && <p>{errors.education}</p>}
        </label>
        ...
        <label>
          ...
          <input
            type="text"
            name="country"
            defaultValue={education.address.country}
            onChange={handleEducationChange}
          />
          {errors.education && <p>{errors.education}</p>}
        </label>
        ...
        <div>
          <label>
            ...
            {errors.professionalExperience && (
              <p>{errors.professionalExperience}</p>
            )}
          </label>
          <label>
            end date:
